...
import { mockTests } from '../../mocks/testMocks';
...
const TakeTest = () => {
  ...
  useEffect(() => {
    ...
    if (foundTest) {
      setTest(foundTest);
      setTimeLeft(foundTest.dureeMinutes * 60);
    }
    setIsLoading(false);
  }, [id]);
  ...
  const handleSubmitTest = () => {
    ...
    test.questions.forEach(question => {
      ...
      if (question.type === 'single') {
        ...
        if (userAnswer.toLowerCase() === (question.correctAnswers as string).toLowerCase()) {
          score += question.points;
        }
      }
    });
    ...
    const submission: TestSubmission = {
      ...
      startTime: new Date(Date.now() - (test.dureeMinutes * 60 * 1000) + timeLeft * 1000),
      endTime: new Date(),
  ...
  if (!test) {
    return (
      <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-100 text-center">
        ...
        <p className="text-gray-500 mb-4">The test you're looking for doesn't exist or has been removed.</p>
        <button
  ...
  if (testCompleted) {
    return (
      <div className="flex flex-col items-center justify-center py-12">
        ...
        <p className="text-gray-500 mb-6">Your answers have been recorded and are being processed.</p>
    ...
    return (
      <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
        <div className="bg-blue-50 p-6">
          ...
          <p className="mt-2 text-gray-600">{test.description || 'Please complete this assessment to the best of your ability.'}</p>
        </div>
          ...
          <div className="space-y-4">
            <div className="flex items-start">
              ...
              <div className="ml-3">
                ...
                <p className="text-sm text-gray-500">{test.dureeMinutes} minutes</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                ...
                <p className="text-sm text-gray-500">Results will be available immediately after completion.</p>
              </div>
            </div>
          </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
        <div className="bg-blue-50 p-4 flex justify-between items-center">
          ...
          <div className="flex items-center">
            ...
            <span 
              className={`font-medium ${timeLeft < 60 ? 'text-red-600' : timeLeft < 300 ? 'text-yellow-600' : 'text-gray-700'}`}
            >
              {formatTime(timeLeft)}
            </span>
          </div>
                ...
                {currentQuestion.options.map((option, index) => (
                  ...
                  >
                    <input
                      ...
                      onChange={() => handleSingleChoiceAnswer(currentQuestion.id, option)}
                ...
                {currentQuestion.options.map((option, index) => (
                  ...
                  >
                    <input
                      ...
                      onChange={() => handleMultipleChoiceAnswer(currentQuestion.id, option)}
